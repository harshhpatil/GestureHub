...
class MusicController(BaseController):
    def __init__(self):
        ...
        if SPOTIFY_AVAILABLE:
            ...
            print("WARNING: Spotify integration requires spotipy library")
        ...
        if not self.spotify_ready:
            if PYGAME_AVAILABLE:
                ...
                print("WARNING: Neither Spotify nor local music playback is available")
                print("Music features will be disabled")
                # Don't raise exception - allow GUI to continue
                self.mode = "disabled"
